...
export const MOCK_TASKS: TaskCatalogItem[] = [
  {
    ...
    name: "Quét sàn",
    slug: "sweep",
    description: "Quét sạch toàn bộ sàn nhà",
    price: 50000,
    isActive: true,
    sortOrder: 1,
  },
  {
    ...
    name: "Lau sàn",
    slug: "mop",
    description: "Lau sàn bằng nước lau sàn chuyên dụng",
    price: 60000,
    isActive: true,
    sortOrder: 2,
  },
  {
    ...
    name: "Hút bụi",
    slug: "vacuum",
    description: "Hút bụi thảm, sofa và góc khuất",
    price: 70000,
    isActive: true,
    sortOrder: 3,
  },
  {
    ...
    name: "Lau nội thất",
    slug: "wipe_furniture",
    description: "Lau bụi bàn ghế, tủ kệ",
    price: 80000,
    isActive: true,
    sortOrder: 4,
  },
  {
    ...
    name: "Lau kính",
    slug: "wipe_glass",
    description: "Lau cửa kính, gương",
    price: 55000,
    isActive: true,
    sortOrder: 5,
  },
  {
    ...
    slug: "clean_toilet",
    description: "Vệ sinh toilet, lavabo",
    price: 90000,
    isActive: true,
    sortOrder: 6,
  },
  ...
  },
  {
    ...
    name: "Rửa bát",
    slug: "wash_dishes",
    description: "Rửa bát đĩa sau bữa ăn",
    price: 45000,
    isActive: true,
    sortOrder: 8,
  },
    ...
    tasks: [
      {
        ...
        taskPrice: 50000,
        isDone: true,
        photoBefore: "/placeholder-before.jpg",
        photoAfter: "/placeholder-after.jpg",
      },
      {
        taskCatalogId: "t6",
        taskName: "Dọn nhà vệ sinh",
        taskPrice: 90000,
        isDone: false,
      },
    ],
...
export const MOCK_REVIEWS: Review[] = [
  {
    ...
    cleanerName: "Trần Văn Hùng",
    rating: 5,
    comment: "Rất hài lòng, dọn sạch và đúng giờ!",
  ...
  },
  {
    ...
    orderId: "ord010",
    customerName: "Phạm Thu Hà",
    cleanerName: "Nguyễn Thị Lan",
    rating: 2,
    comment: "Một số góc chưa dọn kỹ",
  ...
  customer: [
    {
      ...
      body: "Vệ sinh tổng quát cho căn hộ A-1204 đã hoàn thành xuất sắc.",
      isRead: false,
      referenceId: "ord001",
      referenceType: "order",
    ...
    },
    {
      _id: "n2",
      recipientId: "u001",
      type: "CLEANER_CHECKED_IN",
      title: "Bắt đầu dọn dẹp",
      body: "Nhân viên đã bắt đầu công việc tại địa chỉ của bạn.",
      isRead: false,
      referenceId: "ord001",
      referenceType: "order",
    ...
    },
    {
      ...
      body: "Chuyên gia Lê Thị Thanh đã được điều phối cho đơn của bạn.",
      isRead: false,
      referenceId: "ord002",
      referenceType: "order",
    ...
    },
    {
      ...
      body: "Đơn hàng của bạn đã có thay đổi.",
      isRead: true,
      referenceId: null,
      referenceType: null,
  ...
  cleaner: [
    {
      ...
      body: "Có đơn PENDING tại Quận 3 — 05/06",
      isRead: false,
      referenceId: "ord005",
      referenceType: "order",
      createdAt: "2026-05-30T10:00:00Z",
    },
    {
      ...
      title: "Đánh giá mới",
      body: "Khách hàng đánh giá 5 sao cho đơn #ord004",
      isRead: true,
      referenceId: "ord004",
      referenceType: "order",
...
export const MOCK_COMPLAINTS: Complaint[] = [
  {
    ...
    description: "Khách phàn nàn góc bếp còn dầu mỡ",
    evidenceUrls: [],
    status: "PROCESSING",
  ...
  },
  {
    ...
    customerId: "c002",
    customerName: "Phạm Thu Hà",
    subject: "Khách không có mặt",
    description: "NV đến đúng giờ nhưng không vào được nhà",
    evidenceUrls: [],
    status: "OPEN",
    category: null,
    replies: [],
  ...
  },
  {
    ...
    customerId: "u001",
    customerName: "Nguyễn Minh An",
    subject: "Trễ giờ 30 phút",
    description: "NV đến muộn không báo trước",
    evidenceUrls: [],
    status: "RESOLVED",
...
export const MOCK_AI = {
  ...
  assistantReply:
    "Doanh thu hôm nay: +12% so với hôm qua. Khu vực top: Hai Bà Trưng. NV xuất sắc: Trần Văn Hùng (4.8★).",
};
...
export function getCleanerCompletedOrders(cleanerId = "u002") {
  return MOCK_ORDERS.filter(
    (o) => o.cleanerId === cleanerId && o.status === "COMPLETED",
  );
}
